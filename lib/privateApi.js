...
HuobiPrivate.prototype.query = async function(options) {
...
HuobiPrivate.prototype.getQuery = async function(path, query) {
  var options = {
    method: "GET",
...
HuobiPrivate.prototype.otherQuery = async function(method, path, query) {
  var options = {
    method: method,
    url: this.endPoint + path,
    data: query,

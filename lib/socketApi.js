...
//      try {
        var message,parts,method,symbol;
              ...
              default: // non-promises-based
                ...
                switch(parts.length) {
                  ...
                  case 4:
                    method=parts[0]+"."+parts[2]; symbol=parts[1]; break;
                  case 5:
                    method=parts[0]+"."+parts[2]+"."+parts[3]; symbol=parts[1]; break;
                  default:
                ...
                if (this._handles.has(method)) { // orders
                  this._handles.get(method).forEach(cb => { cb(method,message[Object.keys(message)[2]],symbol); }); //  tick or data
                } else {
